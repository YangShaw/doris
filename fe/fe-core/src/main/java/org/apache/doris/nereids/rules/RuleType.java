...
public enum RuleType {
    ...
    BINDING_WINDOW_SLOT(RuleTypeClass.REWRITE),
    ...
    BINDING_WINDOW_FUNCTION(RuleTypeClass.REWRITE),
    ...
    // RESOLVE_WINDOW_FUNCTION(RuleTypeClass.REWRITE),
    WINDOW_FUNCTION_FROM_SORT_AGG(RuleTypeClass.REWRITE),
    WINDOW_FUNCTION_FROM_SORT_PROJECT(RuleTypeClass.REWRITE),
    WINDOW_FUNCTION_FROM_PROJECT(RuleTypeClass.REWRITE),
    WINDOW_FUNCTION_FROM_AGG(RuleTypeClass.REWRITE),
    WINDOW_FUNCTION_FROM_SORT(RuleTypeClass.REWRITE),
    RESOLVE_WINDOW_FUNCTION(RuleTypeClass.REWRITE),
    ...
    EXTRACT_WINDOW_EXPRESSIONS(RuleTypeClass.REWRITE),
    NORMALIZE_WINDOW(RuleTypeClass.REWRITE),
