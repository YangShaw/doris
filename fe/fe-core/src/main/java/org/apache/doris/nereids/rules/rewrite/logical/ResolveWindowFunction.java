...
public class ResolveWindowFunction extends OneRewriteRuleFactory {
    ...
    public Rule build() {
        return RuleType.RESOLVE_WINDOW_FUNCTION.build(
            logicalWindow().when(window -> window.getWindowFrameGroup() == null).then(logicalWindow ->
                resolveWindow(logicalWindow))
        );
    }
    ...
    private LogicalWindow resolveWindow(LogicalWindow<GroupPlan> logicalWindow) {
        ...
        // check
        windowList.stream().map(windowAlias -> {
            ...
            return windowAlias.withChildren(checker.getWindow());
        });

        return new LogicalWindow(logicalWindow.getOutputExpressions(), windowList, logicalWindow.child());
...
//    private LogicalPlan createLogicalPlanNodeForWindowFunctions(LogicalPlan root, LogicalWindowToPhysicalWindow.OrderKeyGroup orderKeyGroup,
...
//        for (LogicalWindowToPhysicalWindow.WindowFrameGroup windowFrameGroup : orderKeyGroup.groupList) {
...
//    }
//
//    private LogicalPlan createLogicalSortNode(LogicalPlan root, LogicalWindowToPhysicalWindow.OrderKeyGroup orderKeyGroup) {
...
//    }
//
//    private PhysicalWindow createLogicalWindow(PhysicalPlan root, LogicalWindowToPhysicalWindow.WindowFrameGroup windowFrameGroup,
//                                               LogicalWindow logicalWindow) {
//        // todo: partitionByEq and orderByEq
//        // LogicalWindow newWindow = logicalWindow.withWindowFrameGroup(windowFrameGroup);
...
//            root);
//        // return (LogicalWindow) newWindow.withChildren(root);
//    }
...
//    private List<LogicalWindowToPhysicalWindow.WindowFrameGroup> createCommonWindowFrameGroups(List<NamedExpression> windowList) {
//        List<LogicalWindowToPhysicalWindow.WindowFrameGroup> windowFrameGroupList = Lists.newArrayList();
//        for (int i = 0; i < windowList.size(); i++) {
//            NamedExpression windowAlias = windowList.get(i);
//
//            boolean matched = false;
//            for (LogicalWindowToPhysicalWindow.WindowFrameGroup windowFrameGroup : windowFrameGroupList) {
...
//            }
//            if (!matched) {
//                windowFrameGroupList.add(new LogicalWindowToPhysicalWindow.WindowFrameGroup(windowAlias));
//            }
//        }
//
//        for (LogicalWindowToPhysicalWindow.WindowFrameGroup wfg : windowFrameGroupList) {
...
//    }
//
//    private List<LogicalWindowToPhysicalWindow.OrderKeyGroup> createCommonOrderKeyGroups(List<LogicalWindowToPhysicalWindow.WindowFrameGroup> windowFrameGroupList) {
//        List<LogicalWindowToPhysicalWindow.OrderKeyGroup> orderKeyGroupList = Lists.newArrayList();
//
//        for (LogicalWindowToPhysicalWindow.WindowFrameGroup windowFrameGroup : windowFrameGroupList) {
//            boolean matched = false;
//            for (LogicalWindowToPhysicalWindow.OrderKeyGroup orderKeyGroup : orderKeyGroupList) {
...
//            }
//            if (!matched) {
//                orderKeyGroupList.add(new LogicalWindowToPhysicalWindow.OrderKeyGroup(windowFrameGroup));
//            }
//        }
//
//        for (LogicalWindowToPhysicalWindow.OrderKeyGroup okg : orderKeyGroupList) {
//            okg.setTupleSize(okg.getGroupList().stream().mapToInt(LogicalWindowToPhysicalWindow.WindowFrameGroup::getTupleSize).sum());
//        }
//
//        return orderKeyGroupList;
//    }
//
//    private List<LogicalWindowToPhysicalWindow.PartitionKeyGroup> createCommonPartitionKeyGroups(List<LogicalWindowToPhysicalWindow.OrderKeyGroup> orderKeyGroupList) {
//        List<LogicalWindowToPhysicalWindow.PartitionKeyGroup> partitionKeyGroupList = Lists.newArrayList();
//
//        for (LogicalWindowToPhysicalWindow.OrderKeyGroup orderKeyGroup : orderKeyGroupList) {
//            boolean matched = false;
//            for (LogicalWindowToPhysicalWindow.PartitionKeyGroup partitionKeyGroup : partitionKeyGroupList) {
...
//            }
//            if (!matched) {
//                partitionKeyGroupList.add(new LogicalWindowToPhysicalWindow.PartitionKeyGroup(orderKeyGroup));
//            }
//        }
//
//        for (LogicalWindowToPhysicalWindow.PartitionKeyGroup pkg : partitionKeyGroupList) {
//            pkg.setTupleSize(pkg.getGroupList().stream().mapToInt(LogicalWindowToPhysicalWindow.OrderKeyGroup::getTupleSize).sum());
//        }
//
//        return partitionKeyGroupList;
//    }
//
//    private void mergeOrderKeyGroups(List<LogicalWindowToPhysicalWindow.OrderKeyGroup> orderKeyGroupList) {
//        boolean merged = true;
//
//        while (merged) {
//            merged = false;
//            for (LogicalWindowToPhysicalWindow.OrderKeyGroup okg1 : orderKeyGroupList) {
//                for (LogicalWindowToPhysicalWindow.OrderKeyGroup okg2 : orderKeyGroupList) {
...
//    }
//
//    private void mergePartitionKeyGroups(List<LogicalWindowToPhysicalWindow.PartitionKeyGroup> partitionKeyGroupList) {
//        boolean merged = true;
//
//        while (merged) {
//            merged = false;
//            for (LogicalWindowToPhysicalWindow.PartitionKeyGroup pkg1 : partitionKeyGroupList) {
//                for (LogicalWindowToPhysicalWindow.PartitionKeyGroup pkg2 : partitionKeyGroupList) {
//                    if (pkg1 != pkg2) {
//                        // todo:
//                        pkg1.absorb(pkg2);
...
//     */
//    private void sortPartitionKeyGroups(List<LogicalWindowToPhysicalWindow.PartitionKeyGroup> partitionKeyGroupList) {
//
//        LogicalWindowToPhysicalWindow.PartitionKeyGroup noPartition = null;
...
//    }
//
//    private void sortOrderKeyGroups(List<LogicalWindowToPhysicalWindow.OrderKeyGroup> orderKeyGroupList) {
...
//    }
//
//    private void sortWindowFrameGroups(List<LogicalWindowToPhysicalWindow.WindowFrameGroup> windowFrameGroupList) {
...
//     */
//    public static class WindowFrameGroup extends LogicalWindowToPhysicalWindow.WindowFunctionRelatedGroup<NamedExpression> {
//
...
//     */
//    private static class OrderKeyGroup extends LogicalWindowToPhysicalWindow.WindowFunctionRelatedGroup<LogicalWindowToPhysicalWindow.WindowFrameGroup> {
//
//        private final List<Expression> partitionKeyList;
//        private final List<OrderKey> orderKeyList;
//
//        public OrderKeyGroup(LogicalWindowToPhysicalWindow.WindowFrameGroup windowFrameGroup) {
...
//
//        @Override
//        public boolean isCompatible(LogicalWindowToPhysicalWindow.WindowFrameGroup windowFrameGroup) {
...
//         */
//        public boolean isPrefixOf(LogicalWindowToPhysicalWindow.OrderKeyGroup otherOkg) {
...
//        }
//
//        public void absorb(LogicalWindowToPhysicalWindow.OrderKeyGroup otherOkg) {
...
//     */
//    private static class PartitionKeyGroup extends LogicalWindowToPhysicalWindow.WindowFunctionRelatedGroup<LogicalWindowToPhysicalWindow.OrderKeyGroup> {
//        public List<Expression> partitionKeyList;
//
//        public PartitionKeyGroup(LogicalWindowToPhysicalWindow.OrderKeyGroup orderKeyGroup) {
//            partitionKeyList = orderKeyGroup.partitionKeyList;
//            groupList.add(orderKeyGroup);
//        }
//
//        @Override
//        public boolean isCompatible(LogicalWindowToPhysicalWindow.OrderKeyGroup orderKeyGroup) {
...
//         */
//        public void absorb(LogicalWindowToPhysicalWindow.PartitionKeyGroup otherPkg) {
