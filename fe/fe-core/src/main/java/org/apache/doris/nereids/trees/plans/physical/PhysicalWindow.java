...
public class PhysicalWindow<CHILD_TYPE extends Plan> extends PhysicalUnary<CHILD_TYPE> implements Window,
    ...
    public PhysicalWindow(List<NamedExpression> outputExpressions,
        ...
        this(outputExpressions, windowFrameGroup, null, Optional.empty(), logicalProperties, child);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(outputExpressions, windowFrameGroup, requireProperties);
    }
    ...
    public Plan withChildren(List<Plan> children) {
        ...
        return new PhysicalWindow<>(outputExpressions, windowFrameGroup,
